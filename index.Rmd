...
Makerere Summer School 2026.

Monday 14th September - Friday 18th September 2026
...
* The ["ggplot2: Elegant Graphics for Data
  ...
  ggplot2, covering the concepts introduced in this course and more advanced
  plotting and customization
* A number of very handy cheatsheets for a variety of R packages, including the
  tidyverse packages, can be found on the [RStudio
  website](https://posit.co/resources/cheatsheets/). As you are beginning to
  learn how to use these packages it is well worth printing these out and
  having to hand.
