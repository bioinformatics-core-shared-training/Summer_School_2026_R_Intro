...
# Factors
R has a special vector class for dealing with categorical data - the *factor*.
...
## Data frames
The most commonly used data structure is the `data.frame`. This can be thought
...
available built-in data sets with the `data()` command.
